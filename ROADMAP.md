...
| v0.2 benchmark readiness | `python -m tools.release.v02_benchmark_readiness --metrics-json ... --rollout-speed-report ... --efficiency-report ... --output ... --require-ok` reconciles measured eval, efficiency, AR rollout speed, and release-input provenance into `v0.2_benchmark_readiness_report.json` | New v0.2 gate for [#197](https://github.com/AbdelStark/GenoLeWM/issues/197); expected `ok=false` until broader benchmark rows, non-fixture release inputs, and the [#42](https://github.com/AbdelStark/GenoLeWM/issues/42) rollout speed target pass |
