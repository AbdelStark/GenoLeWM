...
artifact-chain framing. Future work should package a new v0.2
model/data/paper release and close the true #42 K20 speed target instead
of treating the accepted v0.2 scope decision as speed evidence.
