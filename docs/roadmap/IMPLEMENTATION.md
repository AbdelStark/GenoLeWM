...
| ClinVar, baseline, and rollout evaluation | #53, #55, #56, #57 | June 8 v0.2 readiness evidence exists for coding/non-coding ClinVar, Carbon baselines, BRCA2/TraitGym, rollout state rows, and exact evaluated variant identities; future work is new v0.2 model/data/paper packaging and true #42 speed closure |
