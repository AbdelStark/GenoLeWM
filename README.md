...
readiness report records input artifact identities and command path
arguments with public-safe paths plus SHA-256 and size where applicable,
so absolute CLI paths do not enter the report. The
