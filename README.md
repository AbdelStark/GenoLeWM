...
The report preserves negative findings: the model trails Carbon on most
...
- keep the June 8 v0.2 benchmark artifacts public and rerun the suite
  when model/data lineage changes;
